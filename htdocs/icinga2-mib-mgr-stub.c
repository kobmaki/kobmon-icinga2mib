...
static oid i2Name[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 3};
static oid i2StateType[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 4};
static oid i2DisplayName[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 5};
static oid i2Notes[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 6};
static oid i2NotesUrl[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 7};
static oid i2Output[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 8};
static oid i2CheckCommand[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 9};
static oid i2CheckAttempt[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 10};
static oid i2EnableActiveChecks[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 11};
static oid i2EnableEventHandler[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 12};
static oid i2EnableFlapping[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 13};
static oid i2EnableNotfications[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 14};
static oid i2EnablePassiveCheck[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 15};
static oid i2EnablePerfdata[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 16};
static oid i2Active[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 17};
static oid i2Global[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 18};
static oid i2Address[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 19};
static oid i2Address6[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 20};
static oid i2Parent[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 21};
static oid i2HaMode[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 22};
static oid i2LastCheck[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 99};
static oid i2CheckInterval[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 100};
static oid i2CheckPeriod[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 0, 101};
static oid i2HostName[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 1, 1};
static oid i2StateHost[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 1, 4};
static oid i2ServiceName[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 2, 1};
static oid i2StateService[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 2, 2};
static oid i2NotificationType[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 6};
static oid i2UserPager[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 10, 1};
static oid i2EndpointName[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 13, 1};
static oid i2ZoneName[] = {1, 3, 6, 1, 4, 1, 12483, 999, 2, 1, 14, 1};

int icinga2_mib_mgr_get_i2ObjectAttributes(struct snmp_session *s, i2ObjectAttributes_t **i2ObjectAttributes)
{
...
int icinga2_mib_mgr_get_i2GenericAttribute(struct snmp_session *s, i2GenericAttribute_t **i2GenericAttribute)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
...
int icinga2_mib_mgr_get_i2HostAttributes(struct snmp_session *s, i2HostAttributes_t **i2HostAttributes)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
...
int icinga2_mib_mgr_get_i2ServiceAttributes(struct snmp_session *s, i2ServiceAttributes_t **i2ServiceAttributes)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
...
int icinga2_mib_mgr_get_i2UserAttributes(struct snmp_session *s, i2UserAttributes_t **i2UserAttributes)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
...
int icinga2_mib_mgr_get_i2EndpointAttributes(struct snmp_session *s, i2EndpointAttributes_t **i2EndpointAttributes)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
...
int icinga2_mib_mgr_get_i2ZoneAttributes(struct snmp_session *s, i2ZoneAttributes_t **i2ZoneAttributes)
{
    struct snmp_session *peer;
    struct snmp_pdu *request, *response;
    struct variable_list *vars;
